import type { IconType } from 'react-icons';import type {reactionCountsType, ReactionType} from '../../../store/apis/postsApi'
...
function ReactionPicker({reactionCounts = reactionCountsNew} : {reactionCounts?: Record<ReactionType, number>}) {
